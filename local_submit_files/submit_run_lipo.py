...
cli_arguments = {
    ...
    "training_data_dirs": "gayane/lipo",
    "valid_data_dir": "",
    # "max_steps":120000,
    "num_train_epochs": 10,
    ...
    "checkpoints_root_dir": "/nfs/dgx/raid/chem/experiments/checkpoints/",
    "flash_attn": False,
    "track": True,
...
if __name__ == "__main__":
    ...
    with conditional_context_manager(rsync_enabled, repo_path):
        ...
        #                     cli_arguments[
        #                         "experiment_name"
        #                     ] = f"lipo_0717_lr{lr}_wu{wu}_epoch{ep}_nef{nfn}"
        #                     command = get_command(use_accelerate)
        ...
        with executor.batch():
            for rs in range(42, 72, 10):
                wup = (
                    int(0.2 * cli_arguments["num_train_epochs"])
