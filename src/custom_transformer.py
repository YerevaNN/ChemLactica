...
from transformers.utils import is_torch_fx_available, logging, replace_return_docstrings
...
class CustomOPTForCausalLM(OPTForCausalLM):
    """
        Custom OPT model for supporting flash attention
        and casting the logits to float32
    """
...
transformers.models.opt.modeling_opt.OPTDecoderLayer = CustomOPTDecoderLayer
transformers.models.opt.modeling_opt.OPTForCausalLM = CustomOPTForCausalLM
