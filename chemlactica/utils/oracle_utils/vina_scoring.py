...
# below parameters taken from https://github.com/schwallergroup/augmented_memory/blob/6170fa4181c0bc5b7523e49bdc5bfd2b60f2a6a9/beam_enumeration_reproduce_experiments/drug-discovery-experiments/drd2/docking.json
NUM_POSES = 1 
VINA_SEED = 42
MAXIMUM_ITERATIONS = 600
CENTERS = [9.93,5.85,-9.58]
SIZES = [15,15,15]
VINA_EXHAUSTIVENESS=8 # please see https://github.com/MolecularAI/DockStream/blob/c62e6abd919b5b54d144f5f792d40663c9a43a5b/dockstream/utils/enums/AutodockVina_enums.py#L74
...
def get_vina_score(smiles_to_score: Union[str,List], vina_obj:Vina, receptor):
    ...
    for smiles in smiles_to_score:
        try:
            ...
            energies = vina_obj.dock(exhaustiveness=VINA_EXHAUSTIVENESS, n_poses=NUM_POSES)
...
def main():
    smiles = "CCO"
    pdbqt_ligand = smiles_to_reasonable_conformer_pdbqt(smiles)
